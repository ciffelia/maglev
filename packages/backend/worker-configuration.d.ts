// Generated by Wrangler by running `wrangler types packages/backend/worker-configuration.d.ts` (hash: b7d061a90a2895b713e9bfd9cd28aba5)
// Runtime types generated with workerd@1.20250317.0 2025-03-17 
declare namespace Cloudflare {
	interface Env {
		GITHUB_REPO_URL: "https://github.com/ciffelia/maglev";
		AUTH_TOKEN: string;
		DB: D1Database;
	}
}
